...
//----------------------------------------------------------------------------------------------------------------------------------- 
#define					VER_STR		"250410_1"					//Cheetah 브랜치 변경
//#define					VER_STR		"250410_1"				//이물조명 수동 조작 완료, 2
...
enum MODEL_CHEETAH { A_MODEL = 0, B_MODEL, C_MODEL, D_MODEL, E_MODEL, F_MODEL, G_MODEL, H_MODEL, I_MODEL};

enum COLOR_CHEETAH { R_COLOR = 0, G_COLOR, B_COLOR};
...
{
	LIGHT_RMS_D56 = 0, LIGHT_RMS_BLUE , LIGHT_RMS_GREEN , LIGHT_RMS_RED
};
...
enum LED_LIGHT_DATA {
	...
	LEDDATA_OC, LEDDATA_EPOXY_INSP, LEDDATA_RESIN_CALC, LEDDATA_LENS, LEDDATA_D6500, LEDDATA_DEFECT, LEDDATA_OC_BLUE, LEDDATA_OC_GREEN, LEDDATA_OC_RED,
	MAX_LIGHT_DATA
};
...
enum RAW_CAPTURE_TYPE { MID_6500K_RAW = 0, LOW_LEVEL_RAW, MID_2800K_RAW, UV_BEFORE_CHART, UV_AFTER_CHART, EOL_CHART, CHART_RAW, CHART_SECOND_RAW , LENSSHADING};
